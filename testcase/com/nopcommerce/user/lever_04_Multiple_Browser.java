...
public class lever_04_Multiple_Browser extends BaseTest {
	...
	public void Login_01_Empty_Data() {
		...
		// Assert.assertEquals(loginPage.getErrorMessageAtEmailTextbox(), "Please enter
		// your email");
	}
	...
	public void Login_02_Invalid_Email() {
		...
		// loginPage.clickToLoginButton();
		// Assert.assertEquals(loginPage.getErrorMessageAtEmailTextbox(), "Wrong
		// email");
	}
	...
	public void Login_03_Unregister_Email() {
		...
		// loginPage.inputToPasswordTextbox(passWord);
		// loginPage.clickToLoginButton();
		// Assert.assertEquals(loginPage.getErrorMessageEmailUnregister(), "Login was
	...
	public void Login_04_Empty_Password() {
		...
		// loginPage.clickToLoginButton();
		// Assert.assertEquals(loginPage.getErrorMessageAtPasswordTextbox(), "Login was
		// unsuccessful. Please correct the errors and try again.\nThe credentials
	...
	public void Login_05_Wrong_Password() {
		...
		// loginPage.clickToLoginButton();
		// Assert.assertEquals(loginPage.getErrorMessageAtWrongPasswordTextbox(),"Login
