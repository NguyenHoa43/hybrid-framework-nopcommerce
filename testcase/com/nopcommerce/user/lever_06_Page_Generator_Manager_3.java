...
public class lever_06_Page_Generator_Manager_3 extends BaseTest {
	...
	public void Login_03_Unregister_Email() {
		...
		UserLoginPage.inputToPasswordTextbox(passWord);
		UserLoginPage.clickToLoginButton();
		Assert.assertEquals(UserLoginPage.getErrorMessageEmailUnregister(),
	...
	public void Login_04_Empty_Password() {
		...
		UserLoginPage.clickToLoginButton();
		Assert.assertEquals(UserLoginPage.getErrorMessageAtPasswordTextbox(),
	...
	public void Login_05_Wrong_Password() {
		...
		UserLoginPage.clickToLoginButton();
		Assert.assertEquals(UserLoginPage.getErrorMessageAtWrongPasswordTextbox(),
				"Login was unsuccessful. Please correct the errors and try again.\nThe credentials provided are incorrect");
	}
