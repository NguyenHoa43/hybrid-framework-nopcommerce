...
public class lever_14_Log_ReportNG extends BaseTest {
	...
	public void Upload_01_One_file_per_Time() {
		...
		log.info("Upload - Step 03: Click To star button");
		// step 3 - Click To star button
		homepage.clickToStartButton();
		log.info("Upload - Step 04: Verify upload");
		// step 4 - Verify upload
		verifyTrue(homepage.isFileLinkUpLoadedByName(oneFile));
		log.info("Upload - Step 05: Verify image displayd");
