...
public class BasePage {
	...
	protected void selectItemInCustomDropdown(WebDriver driver, String xpathLocator, String parentXpath, String childXpath, String expectedTextItem ) {
		getWebElement(driver, xpathLocator).click();
				sleep(3);
	...
	protected String getElementAttribute(WebDriver driver, String xpathLocator, String attributeValue) {
	...
	protected String getElementCssValue(WebDriver driver, String xpathLocator, String propertiesName) {
		return getWebElement(driver, xpathLocator).getCssValue(propertiesName);
	}
	...
	protected void waitAllElementVisible(WebDriver driver, String xpathLocator) {
		WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
	...
	protected void waitAllElementInVisible(WebDriver driver, String xpathLocator) {
		WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
	...
	public UserRewardPoinPageObject openRewardPoin(WebDriver driver) {
		...
		return PageGeneratorManager.getRewardPoinPage(driver);
	}
